...
<pre><code>apt-get upgrade -y && apt-get update && apt install git && git clone https://github.com/tmq247/userbot2.git && cd userbot2/ && bash install.sh
</code></pre>
